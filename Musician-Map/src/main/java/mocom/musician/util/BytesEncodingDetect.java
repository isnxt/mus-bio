...
public class BytesEncodingDetect extends Encoding {
    ...
    public int detectEncoding(File testfile) {
        ...
        byte[] rawtext;
        rawtext = new byte[(int) testfile.getAbsolutePath().length()];
        try {
     ...
     * encoding
     */
    public int gb2312_probability(byte[] rawtext) {
        int i, rawtextlen = 0;
     ...
     * encoding
     */
    public int gbk_probability(byte[] rawtext) {
        int i, rawtextlen = 0;
        int dbchars = 1, gbchars = 1;
        long gbfreq = 0, totalfreq = 1;
        float rangeval = 0, freqval = 0;
     ...
     * encoding
     */
    public int gb18030_probability(byte[] rawtext) {
        int i, rawtextlen = 0;
        int dbchars = 1, gbchars = 1;
        long gbfreq = 0, totalfreq = 1;
        float rangeval = 0, freqval = 0;
     ...
     */
    public int big5_probability(byte[] rawtext) {
        int i, rawtextlen = 0;
     ...
     * uses Big5+ encoding
     */
    public int big5plus_probability(byte[] rawtext) {
        int i, rawtextlen = 0;
        int dbchars = 1, bfchars = 1;
        long bffreq = 0, totalfreq = 1;
        float rangeval = 0, freqval = 0;
     ...
     * encoding
     */
    public int euc_tw_probability(byte[] rawtext) {
        int i, rawtextlen = 0;
     ...
     */
    public int iso_2022_cn_probability(byte[] rawtext) {
        int i, rawtextlen = 0;
     ...
     * Unicode
     */
    public int utf8_probability(byte[] rawtext) {
        int score = 0;
        int i, rawtextlen = 0;
     ...
     */
    public int utf16_probability(byte[] rawtext) {
        // int score = 0;
        // int i, rawtextlen = 0;
        // int goodbytes = 0, asciibytes = 0;
     ...
     * reduced
     */
    public int ascii_probability(byte[] rawtext) {
        int score = 75;
        int i, rawtextlen;
        rawtextlen = rawtext.length;
        for (i = 0; i < rawtextlen; i++) {
     ...
     * encoding
     */
    public int euc_kr_probability(byte[] rawtext) {
        int i, rawtextlen = 0;
     ...
     * encoding
     */
    public int cp949_probability(byte[] rawtext) {
        int i, rawtextlen = 0;
        int dbchars = 1, krchars = 1;
        long krfreq = 0, totalfreq = 1;
        float rangeval = 0, freqval = 0;
    ...
    public int iso_2022_kr_probability(byte[] rawtext) {
        int i;
     ...
     * encoding
     */
    public int euc_jp_probability(byte[] rawtext) {
        int i, rawtextlen = 0;
    ...
    public int iso_2022_jp_probability(byte[] rawtext) {
        int i;
        for (i = 0; i < rawtext.length; i++) {
     ...
     * Shift-JIS encoding
     */
    public int sjis_probability(byte[] rawtext) {
        int i, rawtextlen = 0;
        int dbchars = 1, jpchars = 1;
        long jpfreq = 0, totalfreq = 1;
        float rangeval = 0, freqval = 0;
    ...
    public void initialize_frequencies() {
        int i, j;
        for (i = 0; i < 94; i++) {
            for (j = 0; j < 94; j++) {
                GBFreq[i][j] = 0;
